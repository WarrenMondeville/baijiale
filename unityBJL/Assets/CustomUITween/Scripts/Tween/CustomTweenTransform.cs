...
[AddComponentMenu("CustomUITween/Tween/Custom Tween Transform")]
public class CustomTweenTransform : CustomUITweener
{
	...
	static public CustomTweenTransform Begin (GameObject go, float duration, Transform to) { return Begin(go, duration, null, to); }
