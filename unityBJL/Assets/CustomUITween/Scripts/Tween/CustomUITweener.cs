...
public abstract class CustomUITweener : MonoBehaviour
{
	/// <summary>
    /// 当前的补间动画触发回调函数。
	/// </summary>
	static public CustomUITweener current;
	...
	static public T Begin<T> (GameObject go, float duration) where T : CustomUITweener
	{
