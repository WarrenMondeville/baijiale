...
public interface CustomUITweenEventSystemsInterface : IPointerEnterHandler, IPointerDownHandler, IPointerClickHandler, IPointerUpHandler, IPointerExitHandler
{
    /// <summary>
    /// 悬停
    /// </summary>
